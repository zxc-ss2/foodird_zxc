	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-72 p-b-50">
				<form name="reg-form" method="post" action="../controllers/signup.php" class="login100-form validate-form">
					...
					<div class="container-login100-form-btn">
						...
						<a href="log.php" class="dis-block txt3 hov1 p-r-30 p-t-10 p-b-10 p-l-30">
							Войти
